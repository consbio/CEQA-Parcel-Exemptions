...
intermediate_ws = r"P:\Projects3\CEQA_Site_Check_Version_1_0_2021_mike_gough\Tasks\CEQA_Parcel_Exemptions\Data\Intermediate\Intermediate.gdb"
...
fields = [
    ...
    "name",  # 1
    "b01003_001e",  # 2 #population estimate
    "SUM_POP10",  # 3
    "shape_Area",  # 4
    "city_name",  # 5
